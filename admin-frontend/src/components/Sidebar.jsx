...
export default function Sidebar({ isOpen, onClose }) {
  ...
  return (
    <aside className={`fixed inset-y-0 left-0 w-64 bg-white dark:bg-dark-card border-r border-gray-200 dark:border-dark-border z-[60] transform transition-transform duration-300 ease-in-out flex flex-col md:relative md:translate-x-0 ${isOpen ? 'translate-x-0' : '-translate-x-full'}`}>
